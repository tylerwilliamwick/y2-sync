...
export function createAlbumPlayButton(albumId: string, serverId: string | undefined, title: string, kind: 'album' | 'book' = 'album', supportsPlayback = false): HTMLElement & { disabled: boolean } {
